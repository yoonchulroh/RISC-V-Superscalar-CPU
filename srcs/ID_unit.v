...
module ID_unit # (
    ...
    output hazard_print,
    output hazard_multiply_in_sub_ID,
    output hazard_atomic_in_sub_ID,
    output [2:0] hazard_CSR_value_select_in_sub_ID,
    ...
    assign hazard_memuse = control_memread || control_memwrite;
    assign hazard_print = control_print;
    assign hazard_multiply_in_sub_ID = (IFID_instruction[6:0] == 7'b0110011 && IFID_instruction[31:25] == 1);
    assign hazard_atomic_in_sub_ID = (IFID_instruction[6:0] == 7'b0101111) && (IFID_instruction[31:28] != 4'b0001);
    assign hazard_CSR_value_select_in_sub_ID = control_CSR_value_select;
